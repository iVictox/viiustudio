...
<section class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-slate-900 text-white">
    ...
    <div
        class="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-600/20 rounded-full blur-[100px] pointer-events-none">
    </div>

    <div class="max-w-screen-xl mx-auto px-4 relative z-10 text-center">
        <span
            class="inline-block py-1 px-3 rounded-full bg-blue-900/50 border border-blue-700 text-blue-300 text-xs font-bold uppercase tracking-widest mb-4">
            Precios Transparentes
        </span>
        <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 leading-tight">
            Invierte en tecnología,<br>
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400">no en
                problemas.</span>
        </h1>
        ...
        <div class="flex flex-wrap justify-center gap-3">
            <a href="#web"
                class="px-5 py-2.5 rounded-xl bg-slate-800 border border-slate-700 hover:border-blue-500 hover:text-blue-400 transition-all text-sm font-bold flex items-center gap-2">
                <i class="fas fa-laptop-code"></i> Web
            </a>
            <a href="#sistemas"
                class="px-5 py-2.5 rounded-xl bg-slate-800 border border-slate-700 hover:border-emerald-500 hover:text-emerald-400 transition-all text-sm font-bold flex items-center gap-2">
                <i class="fas fa-server"></i> Sistemas
            </a>
            <a href="#automatizacion"
                class="px-5 py-2.5 rounded-xl bg-slate-800 border border-slate-700 hover:border-purple-500 hover:text-purple-400 transition-all text-sm font-bold flex items-center gap-2">
    ...
    <section id="<?php echo $key; ?>" class="py-24 <?php echo $bgClass; ?> relative scroll-mt-20">
        <div class="max-w-screen-xl mx-auto px-4">
            ...
            <div class="text-center max-w-3xl mx-auto mb-16">
                <div
                    class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-blue-50 text-blue-600 mb-4 text-xl">
                ...
                <?php echo $esDestacado
                    ...
                    : 'border-slate-200 shadow-lg hover:shadow-xl hover:border-blue-300'; ?>">
                        ...
                        <div class="p-8 flex-1 flex flex-col">
                            <h3 class="text-xl font-bold text-slate-900 mb-2"><?php echo htmlspecialchars($plan['titulo']); ?>
                            </h3>
                            ...
                            <div class="bg-slate-50 rounded-lg p-4 mb-6 border border-slate-100 space-y-3">
                                ...
                                <?php if ($setupFee == 0): ?>
                                    <div class="flex justify-between items-center bg-green-100 p-2 rounded border border-green-200">
                                        <span class="text-green-800 font-bold text-xs uppercase tracking-wide">
                                            <i class="fas fa-gift mr-1"></i> Instalación
                                        </span>
                                        <span class="font-extrabold text-green-700 text-sm">GRATIS <span
                                                class="line-through text-green-800/40 text-[10px]">$50</span></span>
                                    </div>
                                <?php elseif ($setupFee > 0 && $setupFee < 30): ?>
                                    <div class="flex justify-between items-center text-sm">
                                        <span class="text-slate-500 font-medium">Configuración inicial:</span>
                                        <div class="flex items-center gap-2">
                                            <span class="text-xs text-slate-400 line-through">$80</span> <span
                                                class="font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded border border-blue-100">$<?php echo number_format($setupFee, 0); ?></span>
                                        </div>
                                    </div>
                                <?php else: ?>
                                    <div class="flex justify-between items-center text-sm">
                                        <span class="text-slate-500 font-medium">Pago único de inicio:</span>
                                ...
                                <?php if (is_array($plan['features'])):
                                    foreach ($plan['features'] as $feature): ?>
                                        <li class="flex items-start">
                                            ...
                                            <span
                                                class="text-slate-600 text-sm font-medium leading-tight"><?php echo htmlspecialchars($feature); ?></span>
                                        </li>
...
<section class="py-20 bg-slate-900 text-white relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        <a href="contacto.php"
            class="inline-block bg-white text-slate-900 hover:bg-blue-50 font-bold py-3 px-8 rounded-full transition-colors shadow-lg">
