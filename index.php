...
<section class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
    ...
    <div class="max-w-screen-xl mx-auto px-4 text-center">
        ...
        <h1 data-aos="fade-up" data-aos-delay="100"
            class="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 mb-6 leading-tight">
            Tu Departamento de Tecnología, <br class="hidden md:block">
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#0040A8] to-blue-500">sin
                complicaciones.</span>
        </h1>

        <p data-aos="fade-up" data-aos-delay="200"
            class="text-lg md:text-xl text-slate-600 mb-10 max-w-2xl mx-auto leading-relaxed">
            Diseñamos páginas web, aplicaciones y sistemas a medida bajo un modelo de suscripción mensual. Olvídate de
            los costes ocultos y enfócate en crecer.
        </p>

        <div data-aos="fade-up" data-aos-delay="300"
            class="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a href="servicios.php"
                class="w-full sm:w-auto px-8 py-4 bg-[#0040A8] text-white font-bold rounded-xl hover:bg-[#003080] transition-all transform hover:-translate-y-1 shadow-lg shadow-blue-900/20">
                Ver Planes y Precios
            </a>
            <a href="portafolio.php"
                class="w-full sm:w-auto px-8 py-4 bg-white text-slate-700 border border-slate-200 font-bold rounded-xl hover:bg-slate-50 transition-all hover:border-[#0040A8] hover:text-[#0040A8]">
                Ver Proyectos
            </a>
        </div>
    </div>
...
<section class="py-10 border-y border-slate-100 bg-slate-50/50">
    <div class="max-w-screen-xl mx-auto px-4">
        <p class="text-center text-sm font-semibold text-slate-400 uppercase tracking-widest mb-6">Tecnologías que
            dominamos</p>
        <div
            ...
            <i class="fab fa-python text-4xl hover:text-blue-500 transition-colors" title="Python"></i>
            <i class="fab fa-golang text-4xl hover:text-cyan-500 transition-colors" title="Go (Golang)"></i>
            ...
            <i class="fas fa-database text-4xl hover:text-blue-800 transition-colors" title="PostgreSQL"></i>
            <i class="fas fa-database text-4xl hover:text-orange-600 transition-colors" title="MySQL"></i>
            <i class="fas fa-server text-4xl hover:text-red-600 transition-colors" title="SQL Server"></i>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div data-aos="fade-right">
                ...
                <p class="text-slate-600 mb-6 text-lg">
                    Muchas agencias te entregan una web y desaparecen. En <strong>Viiu Studio</strong>, trabajamos como
                ...
                <ul class="space-y-4 mb-8">
                    <li class="flex items-start">
                        <div
                            class="flex-shrink-0 w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center mt-1 mr-3">
                            <i class="fas fa-check text-xs text-[#0040A8]"></i>
                        </div>
                        <span class="text-slate-700"><strong>Sin inversión inicial gigante:</strong> Pagas una
                            suscripción mensual cómoda, como pagar la luz o el internet.</span>
                    </li>
                    <li class="flex items-start">
                        <div
                            class="flex-shrink-0 w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center mt-1 mr-3">
                        ...
                        <span class="text-slate-700"><strong>Mantenimiento Incluido:</strong> Tu web nunca quedará
                            obsoleta. Nosotros la cuidamos.</span>
                    </li>
                    <li class="flex items-start">
                        <div
                            class="flex-shrink-0 w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center mt-1 mr-3">
                        ...
                        <span class="text-slate-700"><strong>Escalabilidad:</strong> ¿Empiezas pequeño? Bien. ¿Creces
                            mañana? Mejoramos tu plan al instante.</span>
                    </li>
                </ul>
            ...
            <div class="relative" data-aos="fade-left">
                <div
                    class="absolute top-0 right-0 -mr-20 -mt-20 w-80 h-80 bg-blue-50 rounded-full blur-3xl -z-10 opacity-70">
                </div>

                <div class="grid grid-cols-2 gap-4">
                    <div class="glass-card p-6 rounded-2xl shadow-sm transform translate-y-8">
                        <div
                            class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center text-[#0040A8] mb-4">
...
<section class="py-20 bg-slate-900 text-white relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://wa.me/584120000000"
                class="px-8 py-4 bg-[#0040A8] hover:bg-[#003080] rounded-xl font-bold transition-all shadow-lg shadow-blue-900/50">
                <i class="fab fa-whatsapp mr-2"></i> Iniciar Chat
            </a>
            <a href="contacto.php"
                class="px-8 py-4 bg-transparent border border-white/20 hover:bg-white/10 rounded-xl font-bold transition-all">
                Contáctanos
            </a>
        </div>
    </div>
